...
public class EditFasilitasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_desk = (TextInputEditText)findViewById(R.id.TIET_ef_desk);
        gambar = (ImageView)findViewById(R.id.IV_ef_gambar);
    ...
    public void onSimpan(View view) {
        ...
        yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                progressDialog = new ProgressDialog(EditFasilitasActivity.this);
                progressDialog.setCanceledOnTouchOutside(false);
                progressDialog.setMessage("Loading...");
                progressDialog.show();
                String upload_url = linkDatabase.linkurl()+"fasilitas.php?operasi=update_fasilitas";
...
//                    AdapterBerita.ma.tambah(m);
                    ...
                    protected Map<String, String> getParams() throws AuthFailureError {
                        ...
                        params.put("ID_FASILITAS", str_id);
                ...
                requestQueue    =   Volley.newRequestQueue(EditFasilitasActivity.this);
