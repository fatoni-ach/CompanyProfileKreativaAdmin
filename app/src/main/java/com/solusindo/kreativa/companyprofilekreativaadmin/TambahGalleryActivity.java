...
public class TambahGalleryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_desk = (TextInputEditText)findViewById(R.id.TIET_galery_desk);
        imageView = (ImageView)findViewById(R.id.IV_tg_gambar);
...
//        }
    ...
    public void onSimpan(View view) {
        ...
        progressDialog.show();
        String upload_url = linkDatabase.linkurl()+"galery.php?operasi=insert_galery";
...
//                    Galery m = new Galery();
//                    m.setDESK_GALLERY(et_desk.getText().toString());
//                    m.setTANGGAL_GALERY(time2);
//                    m.setFOTO_GALLERY("images/"+time+"_galery.jpg");
...
//                    AdapterBerita.ma.tambah(m);
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("TANGGAL_GALERY", time);

                return params;
            }
        };
        requestQueue    =   Volley.newRequestQueue(TambahGalleryActivity.this);
